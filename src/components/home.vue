    ...
    submit() {
      ...
      if(this.selected=="options1"){
        for (let key in this.course) {
          this.cgpa += this.course[key].grade * this.options1[this.course[key].credit].credit ;
          this.count += this.options1[this.course[key].credit].credit;
        }
      }else{
        for (let key in this.course) {
          this.cgpa += this.course[key].grade * this.options2[this.course[key].credit].credit ;
